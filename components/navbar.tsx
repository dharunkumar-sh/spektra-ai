...
export function Navbar() {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-2.5 group">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-mono uppercase tracking-widest text-indigo-400 -mt-1 font-semibold">
                API Platform
              </span>
            </div>
          </a>
          ...
          <nav className="hidden md:flex items-center gap-1 bg-[#12131d]/60 border border-white/10 px-4 py-1.5 rounded-full backdrop-blur-sm">
            ...
            >
              <button className="flex items-center gap-1.5 text-sm font-medium text-slate-300 hover:text-white px-3 py-1.5 rounded-full hover:bg-white/5 transition-colors">
                <span>Platform</span>
                <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-200 ${productDropdownOpen ? 'rotate-180 text-indigo-400' : ''}`} />
              </button>

              {/* Mega Dropdown Menu */}
              {productDropdownOpen && (
                <div className="absolute top-full left-0 mt-2 w-80 bg-[#0d0e16]/95 border border-white/15 rounded-2xl p-3 shadow-2xl backdrop-blur-xl animate-in fade-in slide-in-from-top-2 duration-200">
                  <div className="space-y-1">
                    <a href="#interactive-generator" className="flex items-start gap-3 p-2.5 rounded-xl hover:bg-white/5 transition-colors group/item">
                    ...
                    <a href="#adaptive-templates" className="flex items-start gap-3 p-2.5 rounded-xl hover:bg-white/5 transition-colors group/item">
                    ...
                    <a href="#interactive-preview" className="flex items-start gap-3 p-2.5 rounded-xl hover:bg-white/5 transition-colors group/item">
            ...
            <a href="#workflow" className="text-sm font-medium text-slate-300 hover:text-white px-3 py-1.5 rounded-full hover:bg-white/5 transition-colors">
              How It Works
            </a>
            <a href="#features" className="text-sm font-medium text-slate-300 hover:text-white px-3 py-1.5 rounded-full hover:bg-white/5 transition-colors">
              Features
            </a>
            <a href="#ai-intelligence" className="text-sm font-medium text-slate-300 hover:text-white px-3 py-1.5 rounded-full hover:bg-white/5 transition-colors">
              AI Intelligence
            </a>
            <a href="#comparison" className="text-sm font-medium text-slate-300 hover:text-white px-3 py-1.5 rounded-full hover:bg-white/5 transition-colors">
              Comparison
            </a>
            <a href="#pricing" className="text-sm font-medium text-slate-300 hover:text-white px-3 py-1.5 rounded-full hover:bg-white/5 transition-colors">
              Pricing
            </a>
          </nav>
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <a
              ...
              className="flex items-center gap-2 text-xs font-medium text-slate-300 hover:text-white bg-[#1a1b26] hover:bg-[#242636] border border-white/10 px-3 py-2 rounded-xl transition-all"
            >
            ...
            <a
              ...
              className="relative group overflow-hidden rounded-xl p-px font-medium text-sm"
            >
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#0a0b12] border-b border-white/10 px-4 pt-4 pb-6 mt-3 space-y-4 shadow-2xl">
          <div className="flex flex-col space-y-2">
            <a 
              href="#interactive-generator" 
              onClick={() => setMobileMenuOpen(false)}
              className="text-slate-300 hover:text-white font-medium py-2 px-3 rounded-lg hover:bg-white/5"
            >
          ...
          <div className="pt-4 border-t border-white/10 flex flex-col gap-3">
            <a
              href="#interactive-generator"
              onClick={() => setMobileMenuOpen(false)}
              className="w-full text-center bg-gradient-to-r from-indigo-500 to-violet-600 text-white font-medium py-2.5 rounded-xl shadow-lg shadow-indigo-500/25"
            >
